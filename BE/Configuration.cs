...
namespace BE
{
    ...
    public class Configuration
    {
        ...
        private static int orderValidity=1;
        ...
        public static long GuestRequestKey { get => guestRequestKey; set => guestRequestKey = value; }
        public static long HostingUnitKey { get => hostingUnitKey; set => hostingUnitKey+=1; }
        public static long OrderKey { get => orderKey; set => orderKey+=1; }
        public static int Fee { get => fee; set => fee = value; }
        public static string Mng { get => mng; set => mng=value; }
